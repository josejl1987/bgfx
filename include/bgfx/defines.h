...
#define BGFX_STENCIL_FUNC_REF_MASK                UINT64_C(0x000000ff)
#define BGFX_STENCIL_FUNC_REF(v) ( ( (uint64_t)(v)<<BGFX_STENCIL_FUNC_REF_SHIFT )&BGFX_STENCIL_FUNC_REF_MASK)
...
#define BGFX_STENCIL_FUNC_RMASK_MASK              UINT64_C(0x0000ff00)
#define BGFX_STENCIL_FUNC_RMASK(v) ( ( (uint64_t)(v)<<BGFX_STENCIL_FUNC_RMASK_SHIFT )&BGFX_STENCIL_FUNC_RMASK_MASK)

#define BGFX_STENCIL_NONE                         UINT64_C(0x00000000)
#define BGFX_STENCIL_MASK                         UINT64_C(0xffffffff)
#define BGFX_STENCIL_DEFAULT                      UINT64_C(0x00000000)

#define BGFX_STENCIL_TEST_LESS                    UINT64_C(0x00010000) //!< Enable stencil test, less.
#define BGFX_STENCIL_TEST_LEQUAL                  UINT64_C(0x00020000) //!< Enable stencil test, less or equal.
#define BGFX_STENCIL_TEST_EQUAL                   UINT64_C(0x00030000) //!< Enable stencil test, equal.
#define BGFX_STENCIL_TEST_GEQUAL                  UINT64_C(0x00040000) //!< Enable stencil test, greater or equal.
#define BGFX_STENCIL_TEST_GREATER                 UINT64_C(0x00050000) //!< Enable stencil test, greater.
#define BGFX_STENCIL_TEST_NOTEQUAL                UINT64_C(0x00060000) //!< Enable stencil test, not equal.
#define BGFX_STENCIL_TEST_NEVER                   UINT64_C(0x00070000) //!< Enable stencil test, never.
#define BGFX_STENCIL_TEST_ALWAYS                  UINT64_C(0x00080000) //!< Enable stencil test, always.
#define BGFX_STENCIL_TEST_SHIFT                   16                   //!< Stencil test bit shift
#define BGFX_STENCIL_TEST_MASK                    UINT64_C(0x000f0000) //!< Stencil test bit mask

#define BGFX_STENCIL_OP_FAIL_S_ZERO               UINT64_C(0x00000000) //!< Zero.
#define BGFX_STENCIL_OP_FAIL_S_KEEP               UINT64_C(0x00100000) //!< Keep.
#define BGFX_STENCIL_OP_FAIL_S_REPLACE            UINT64_C(0x00200000) //!< Replace.
#define BGFX_STENCIL_OP_FAIL_S_INCR               UINT64_C(0x00300000) //!< Increment and wrap.
#define BGFX_STENCIL_OP_FAIL_S_INCRSAT            UINT64_C(0x00400000) //!< Increment and clamp.
#define BGFX_STENCIL_OP_FAIL_S_DECR               UINT64_C(0x00500000) //!< Decrement and wrap.
#define BGFX_STENCIL_OP_FAIL_S_DECRSAT            UINT64_C(0x00600000) //!< Decrement and clamp.
#define BGFX_STENCIL_OP_FAIL_S_INVERT             UINT64_C(0x00700000) //!< Invert.
#define BGFX_STENCIL_OP_FAIL_S_SHIFT              20                   //!< Stencil operation fail bit shift
#define BGFX_STENCIL_OP_FAIL_S_MASK               UINT64_C(0x00f00000) //!< Stencil operation fail bit mask

#define BGFX_STENCIL_OP_FAIL_Z_ZERO               UINT64_C(0x00000000) //!< Zero.
#define BGFX_STENCIL_OP_FAIL_Z_KEEP               UINT64_C(0x01000000) //!< Keep.
#define BGFX_STENCIL_OP_FAIL_Z_REPLACE            UINT64_C(0x02000000) //!< Replace.
#define BGFX_STENCIL_OP_FAIL_Z_INCR               UINT64_C(0x03000000) //!< Increment and wrap.
#define BGFX_STENCIL_OP_FAIL_Z_INCRSAT            UINT64_C(0x04000000) //!< Increment and clamp.
#define BGFX_STENCIL_OP_FAIL_Z_DECR               UINT64_C(0x05000000) //!< Decrement and wrap.
#define BGFX_STENCIL_OP_FAIL_Z_DECRSAT            UINT64_C(0x06000000) //!< Decrement and clamp.
#define BGFX_STENCIL_OP_FAIL_Z_INVERT             UINT64_C(0x07000000) //!< Invert.
#define BGFX_STENCIL_OP_FAIL_Z_SHIFT              24                   //!< Stencil operation depth fail bit shift
#define BGFX_STENCIL_OP_FAIL_Z_MASK               UINT64_C(0x0f000000) //!< Stencil operation depth fail bit mask

#define BGFX_STENCIL_OP_PASS_Z_ZERO               UINT64_C(0x00000000) //!< Zero.
#define BGFX_STENCIL_OP_PASS_Z_KEEP               UINT64_C(0x10000000) //!< Keep.
#define BGFX_STENCIL_OP_PASS_Z_REPLACE            UINT64_C(0x20000000) //!< Replace.
#define BGFX_STENCIL_OP_PASS_Z_INCR               UINT64_C(0x30000000) //!< Increment and wrap.
#define BGFX_STENCIL_OP_PASS_Z_INCRSAT            UINT64_C(0x40000000) //!< Increment and clamp.
#define BGFX_STENCIL_OP_PASS_Z_DECR               UINT64_C(0x50000000) //!< Decrement and wrap.
#define BGFX_STENCIL_OP_PASS_Z_DECRSAT            UINT64_C(0x60000000) //!< Decrement and clamp.
#define BGFX_STENCIL_OP_PASS_Z_INVERT             UINT64_C(0x70000000) //!< Invert.
#define BGFX_STENCIL_OP_PASS_Z_SHIFT              28                   //!< Stencil operation depth pass bit shift
#define BGFX_STENCIL_OP_PASS_Z_MASK               UINT64_C(0xf0000000) //!< Stencil operation depth pass bit mask
#define BGFX_STENCIL_FUNC_WMASK_SHIFT             32

#define BGFX_STENCIL_FUNC_WMASK_MASK              UINT64_C(0xFF00000000)
#define BGFX_STENCIL_FUNC_WMASK(v) ( ( (uint64_t)(v)<<BGFX_STENCIL_FUNC_WMASK_SHIFT )&BGFX_STENCIL_FUNC_WMASK_MASK)
